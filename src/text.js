...
const CJK_SYNONYMS = {
  ...
  优化: ["optimize", "improve"],
  网页: ["page", "ui", "frontend"],
  布局: ["layout", "ui", "frontend"],
  数据库: ["database", "schema"],
  后端: ["backend"],
  接口: ["api"],
  权限: ["authorization", "permission", "security"],
  安装: ["installation", "install", "docs", "documentation"],
  说明: ["docs", "documentation", "guide"],
  分析: ["analyze", "analysis"],
  选品: ["product", "market"],
  风险: ["risk"],
  销售: ["sales"],
  数据: ["data", "dataset", "metrics"],
  重构: ["refactor", "maintainability"],
  代码: ["code"],
  行为: ["behavior"],
};
...
const ASCII_SYNONYMS = {
  ...
  guides: ["docs", "documentation", "guide"],
